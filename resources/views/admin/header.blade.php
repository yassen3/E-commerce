    ...
    <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
      ...
      <ul class="navbar-nav w-100">
        <li class="nav-item w-100">
          <form class="nav-link mt-2 mt-md-0 d-none d-lg-flex search" method="get" action="{{url('searchproduct')}}" enctype="multipart/form-data">
            @csrf
            <input type="text" name="searchproduct" class="form-control" placeholder="Search products">
          </form>
        </li>
      </ul>
